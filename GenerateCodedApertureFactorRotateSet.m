...
mkdir('DecayMatrixOneView');
mkdir('CodeGeoMatrixOneView');
...
for angle = 1:numAngle %loop for rotation angle
    ...
    saveDecayName = sprintf("DecayMatrixOneView/DecaySysAngle%d.mat",angle);
    ...
    saveGeoName = sprintf("CodeGeoMatrixOneView/GeoSysAngle%d.mat",angle);
